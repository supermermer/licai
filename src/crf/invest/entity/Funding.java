...
public class Funding implements java.io.Serializable {
	...
	private String fundFuiouContractNo;
	/**
	 * 非数据库字段
	 */
	...
	public String getFundFuiouContractNo() {
		return fundFuiouContractNo;
	}

	public void setFundFuiouContractNo(String fundFuiouContractNo) {
		this.fundFuiouContractNo = fundFuiouContractNo;
	}
