...
<input type="hidden" name="flag" value="${flag}">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td><input type="password" name="password" value="${user.password }" title="密码" isneed="Y" length="6~16" /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text"  name="realname" value="${user.realname}" title="真实姓名" isneed="Y" length="2~4" checkType="Chinese" /></td>
        </tr>
        <tr>
