...
<tyTag:page tarFrame="frame1" method="accountController.do?queryAccountListTable" pageTurn="<%=PageUtil.TURN_YES %>"></tyTag:page>
<tyTag:actorBtnTag value="${btn_ids }"/>
</form>
</body>
    <script type="text/javascript">
    	function query(){
    		document.forms[0].action = "accountController.do?queryAccountListTable";
    	...
    	function updateAAA(){
    		...
    		if(confirm("确认提交吗?")){
        		...
        		document.forms[0].action = "accountController.do?updateUploadStatus&selectlist="+selectlist;
